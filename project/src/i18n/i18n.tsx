...
const DICT: Record<Language, Dictionary> = {
  en: {
    ...
    'home.cta.highRisk.title': 'High-Risk Monitor',
    'home.cta.highRisk.desc': 'AI-powered risk assessment to identify patients needing immediate care',
    'home.cta.analytics.title': 'Health Analytics',
    'home.cta.analytics.desc': 'Real-time insights on pilgrim health and crowd demographics',
    'home.cta.lostFound.title': 'Lost & Found',
    'home.cta.lostFound.desc': 'AI face recognition to reunite lost family members',
    ...
    'allergy.dairy': 'Dairy/Milk',
    'allergy.shellfish': 'Shellfish',
    'allergy.treeNuts': 'Tree Nuts',
    'allergy.eggs': 'Eggs',
    'allergy.wheat': 'Wheat/Gluten',
    'allergy.soy': 'Soy',
    'allergy.animalDander': 'Animal Dander',
    'allergy.mold': 'Mold',
    'allergy.insectStings': 'Insect Stings',
    'allergy.medications': 'Medications',
    'allergy.none': 'None',
    'allergy.other': 'Other',
    'reg.chronic': 'Chronic Conditions',
    'reg.chronicPlaceholder': 'Select...',
    'condition.hypertension': 'Hypertension (High BP)',
    'condition.diabetes': 'Diabetes',
    'condition.arthritis': 'Arthritis/Joint Pain',
    'condition.asthma': 'Asthma/COPD',
    ...
    'condition.stroke': 'Stroke/Paralysis',
    'condition.depression': 'Depression/Anxiety',
    'condition.none': 'None',
    ...
    // High Risk Dashboard
    'highRisk.title': 'High-Risk Patients Monitor',
    'highRisk.desc': 'AI-powered risk assessment for proactive medical intervention',
  ...
  hi: {
    ...
    'home.cta.highRisk.title': 'उच्च जोखिम निगरानी',
    'home.cta.highRisk.desc': 'तत्काल देखभाल की आवश्यकता वाले रोगियों की पहचान के लिए AI-संचालित मूल्यांकन',
    'home.cta.analytics.title': 'स्वास्थ्य एनालिटिक्स',
    'home.cta.analytics.desc': 'तीर्थयात्रियों के स्वास्थ्य और भीड़ की जानकारी पर रीयल-टाइम इनसाइट्स',
    'home.cta.lostFound.title': 'खोया-पाया',
    'home.cta.lostFound.desc': 'खोए हुए परिवार के सदस्यों को मिलाने के लिए AI चेहरा पहचान',
    ...
    'allergy.dust': 'धूल',
    'allergy.pollen': 'पराग',
    'allergy.peanuts': 'मूंगफली',
    'allergy.dairy': 'दूध/डेयरी',
    'allergy.shellfish': 'शेलफिश',
    'allergy.treeNuts': 'बादाम/काजू',
    'allergy.eggs': 'अंडे',
    'allergy.wheat': 'गेहूं/ग्लूटेन',
    'allergy.soy': 'सोया',
    'allergy.animalDander': 'जानवरों की रूसी',
    'allergy.mold': 'फफूंद',
    'allergy.insectStings': 'कीड़े के काटने',
    'allergy.medications': 'दवाइयाँ',
    'allergy.none': 'कोई नहीं',
    'allergy.other': 'अन्य',
    ...
    'condition.arthritis': 'गठिया/जोड़ों का दर्द',
    'condition.asthma': 'दमा/सांस की बीमारी',
    'condition.heartDisease': 'हृदय रोग',
    'condition.thyroid': 'थायरॉइड विकार',
    'condition.kidneyDisease': 'किडनी रोग',
    'condition.liverDisease': 'लीवर रोग',
    'condition.cancer': 'कैंसर',
    'condition.stroke': 'लकवा/स्ट्रोक',
    'condition.depression': 'अवसाद/चिंता',
    'condition.none': 'कोई नहीं',
    'condition.other': 'अन्य',
    ...
    // High Risk Dashboard
    'highRisk.title': 'उच्च जोखिम वाले मरीज़ निगरानी',
    'highRisk.desc': 'सक्रिय चिकित्सा हस्तक्षेप के लिए AI-संचालित जोखिम मूल्यांकन',
  ...
  mr: {
    ...
    'home.cta.highRisk.title': 'उच्च धोका निरीक्षण',
    'home.cta.highRisk.desc': 'तातडीची काळजी आवश्यक असलेल्या रुग्णांची ओळख करण्यासाठी AI-आधारित मूल्यांकन',
    'home.cta.analytics.title': 'आरोग्य विश्लेषण',
    'home.cta.analytics.desc': 'यात्रेकरूंच्या आरोग्य आणि गर्दीच्या माहितीवर रीयल-टाइम अंतर्दृष्टी',
    'home.cta.lostFound.title': 'हरवले आणि सापडले',
    'home.cta.lostFound.desc': 'हरवलेल्या कुटुंबातील सदस्यांना एकत्र करण्यासाठी AI चेहरा ओळख',
    ...
    'allergy.dust': 'धूळ',
    'allergy.pollen': 'परागकण',
    'allergy.peanuts': 'शेंगदाणे',
    'allergy.dairy': 'दूध/डेअरी',
    'allergy.shellfish': 'शेलफिश',
    'allergy.treeNuts': 'काजू/बदाम',
    'allergy.eggs': 'अंडी',
    'allergy.wheat': 'गहू/ग्लूटेन',
    'allergy.soy': 'सोया',
    'allergy.animalDander': 'प्राण्यांच्या केसांची',
    'allergy.mold': 'बुरशी',
    'allergy.insectStings': 'कीटकांचे   डंख',
    'allergy.medications': 'औषधे',
    'allergy.none': 'काही नाही',
    'allergy.other': 'इतर',
    'reg.chronic': 'दीर्घकालीन आजार',
    'reg.chronicPlaceholder': 'निवडा...',
    'condition.hypertension': 'उच्च रक्तदाब (BP)',
    'condition.diabetes': 'मधुमेह (Diabetes)',
    'condition.arthritis': 'सांधेदुखी/संधिवात',
    'condition.asthma': 'दमा/श्वास रोग',
    'condition.heartDisease': 'हृदय रोग',
    'condition.thyroid': 'थायरॉईड विकार',
    'condition.kidneyDisease': 'मूत्रपिंड रोग',
    'condition.liverDisease': 'यकृत रोग',
    'condition.cancer': 'कर्करोग',
    'condition.stroke': 'अर्धांगवायू/पक्षाघात',
    'condition.depression': 'नैराश्य/चिंता',
